<template>
  <div
    ...
    class="relative w-full border-t border-b-0 sm:border-t-0 sm:border-b lg:border-b-0 lg:border-r border-black/[.1] order-last sm:order-none sm:mt-1 lg:mr-1 sm:mb-1 lg:mb-0 sm:mx-1 lg:mx-0"
  >
    <ol
      v-if="withShortcut()"
    ...
    >
      <li v-for="(item, i) in withShortcut()" :key="i">
        <a
          href="#"
          class="block px-2 py-2 text-sm font-medium transition-colors rounded litepie-shortcuts lg:text-xs sm:leading-4 whitespace-nowrap text-primary hover:bg-bg-primary focus:bg-bg-secondary"
