      ...
      >
        ...
        >
          <span
            ...
            class="absolute bg-bg-primary bg-opacity-60"
            :class="betweenRangeClasses(date)"
          ></span>
        </transition>
        <button
          type="button"
          class="relative flex items-center justify-center w-12 h-12 text-xs litepie-datepicker-date lg:w-10 lg:h-10 2xl:text-sm focus:outline-none"
          :class="[
