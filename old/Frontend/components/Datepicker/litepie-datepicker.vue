  ...
  >
    ...
    >
      <label class="relative block">
        <!-- class="relative block w-full pl-3 pr-12 py-2.5 rounded-lg overflow-hidden text-sm text-text-primary placeholder-text-secondary transition-colors bg-white border border-bg-primary focus:border-primary focus:ring focus:outline-none" -->
        <input
          ref="LitepieInputRef"
          type="text"
          class="w-full px-4 py-2 transition-all duration-150 ease-in border rounded-sm placeholder:text-text-secondary border-bg-primary text-text-primary hover:bg-bg-primary bg-bg-tertiary focus-visible:border-primary focus-visible:outline-none focus-visible:bg-bg-secondary"
          v-bind="$attrs"
          v-model="pickerValue"
          :placeholder="givenPlaceholder"
          @keyup="keyUp"
        ...
        >
          <button
            type="button"
            class="px-2 py-1 mr-1 rounded-md focus:outline-none text-text-primary"
    ...
    >
      ...
      >
        <div
          class="fixed inset-0 z-50 overflow-y-auto shadow-sm bg-bg-secondary sm:overflow-visible sm:static sm:z-auto sm:rounded-lg"
        >
          <div
            class="litepie-datepicker static sm:relative w-full bg-bg-secondary sm:rounded-lg sm:shadow-sm border-0 sm:border border-black/[.1] px-3 py-3 sm:px-1 sm:py-1.5"
          ...
          >
            <div class="flex flex-wrap lg:flex-nowrap">
              ...
              <div class="relative flex flex-wrap p-1 sm:flex-nowrap">
                ...
                >
                  <div
                    class="w-8 h-1 shadow-inner sm:w-1 sm:h-8 bg-bg-primary rounded-xl"
                  ></div>
                </div>
                <div
                ...
                <div
                  v-if="asRange() && !asSingle"
                  class="relative w-full mt-3 overflow-hidden sm:w-80 sm:mt-0 sm:ml-2"
                >
                  <!--            Header-->
                  <litepie-header
                    as-prev-or-next
            ...
            <div v-if="!autoApply">
              <div class="mt-2 mx-2 py-1.5 border-t border-black/[.1]">
                <div class="mt-1.5 sm:flex sm:flex-row-reverse">
                  <button
                    type="button"
                    class="inline-flex justify-center w-full px-4 py-2 text-base font-medium text-white transition duration-300 ease-out border border-transparent rounded-md shadow-sm away-apply-picker bg-bg-primary hover:bg-bg-primary focus:outline-none sm:ml-3 sm:w-auto sm:text-sm disabled:cursor-not-allowed"
                    :disabled="
                  ...
                  <button
                    type="button"
                    class="inline-flex justify-center w-full px-4 py-2 mt-3 text-base font-medium transition duration-300 ease-out bg-white border rounded-md shadow-sm away-cancel-picker border-primary text-text-secondary hover:bg-bg-secondary focus:outline-none focus:ring-2 focus:ring-offset-2 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm"
            ...
            <div v-else class="sm:hidden">
              <div class="mt-2 mx-2 py-1.5 border-t border-black/[.1]">
                <div class="mt-1.5 sm:flex sm:flex-row-reverse">
                  <button
                    type="button"
                    class="inline-flex justify-center w-full px-4 py-2 text-base font-medium transition duration-300 ease-out bg-white border rounded-md shadow-sm away-cancel-picker border-primary text-text-secondary hover:bg-primary focus:outline-none sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm"
                    v-text="options.footer.cancel"
                  ></button>
                </div>
              </div>
    ...
    const datepickerClasses = (date) => {
      ...
      if (active) {
        classes = today
          ...
          : disabled
          ? `text-text-secondary font-normal disabled:text-text-secondary disabled:cursor-not-allowed rounded-full`
          : date.isBetween(s, e, "date", "()")
          ? `text-text-secondary font-medium rounded-full`
          : `text-text-secondary font-medium rounded-full`;
      }
      if (off) {
        classes = `text-text-secondary font-light disabled:cursor-not-allowed`;
      }
      if (s && e && !off) {
        if (date.isSame(s, "date")) {
          classes = e.isAfter(s, "date")
            ? "bg-primary text-white font-bold rounded-l-full disabled:cursor-not-allowed"
            : "bg-primary text-white font-bold rounded-r-full disabled:cursor-not-allowed";
          if (s.isSame(e, "date")) {
            classes = `bg-bg-primary text-white font-bold rounded-full disabled:cursor-not-allowed`;
          }
        }
